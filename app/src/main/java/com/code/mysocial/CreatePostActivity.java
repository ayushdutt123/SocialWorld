...
import com.code.mysocial.databinding.ActivityCreatePostBinding;
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                PostModel postModel=new PostModel(id, FirebaseAuth.getInstance().getUid(), binding.postText.getText().toString(),
                                        uri.toString(), "0", "0", Calendar.getInstance().getTimeInMillis());
                                FirebaseFirestore.getInstance().collection("Posts").document(id).set(postModel);
                            }
                        })
