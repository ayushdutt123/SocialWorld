...
import com.code.mysocial.databinding.ActivityNewsFeedBinding;
...
public class NewsFeedActivity extends AppCompatActivity {
    ...
    private void loadPosts(){
        FirebaseFirestore.getInstance().collection("Posts").orderBy("postingTime", Query.Direction.DESCENDING).get()
